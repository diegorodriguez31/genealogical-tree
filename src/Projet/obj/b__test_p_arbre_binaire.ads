...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_p_arbre_binaire" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#086ae9f5#;
   pragma Export (C, u00001, "test_p_arbre_binaireB");
   ...
   u00134 : constant Version_32 := 16#60c5948d#;
   pragma Export (C, u00134, "p_arbre_binB");
   u00135 : constant Version_32 := 16#45690812#;
   pragma Export (C, u00135, "p_arbre_binS");
